...
public:
  ...
  void grayLevel(byte val = 0x03)
  {
    ...
    for (byte i = 0; i < 17; i++)
      cmdGrayLevel[i] = val; // data = 3 -- 00000011 -- 11000000
  ...
  void applyStrings(String stringOne = "", String stringTwo = "")
  {
  ...
  {
    applyStrings(stringOne,stringTwo);
    print();
  }
